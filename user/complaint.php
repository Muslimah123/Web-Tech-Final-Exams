                                        ...
                                        <form class="form-horizontal new_complaint"  role="form"  action="sub_complaint.php" method="post">
                                            ...
                                            <div class="row form-group complaint_textarea">
                                                ...
                                                <select  class="form-control" id="complaint" name="complaint" placeholder="select your grievance">
                                                    ...
                                                    <option value="Bill was not accurate ">Bill was not accurate</option>
                                                    <option value="Bill delayed">Bill delayed</option>
                                                    <option value="Transaction was not Processed">Transaction was not Processed</option>
                                                    <option value="No feedback on Previous Complaint">No feedback on Previous Complaint</option>
                                                </select>
