    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- STATISTICS -->
                <h1 style="padding-left:30px; "><small>Statistics</small></h1>
                     ...
                     ?>
                        <table class="table  ">
                            <tbody>
                                <tr>
                                    <td>
                                        <h4>Number of Bills that are Generated</h4>
                                    </td>
                                    <td class="success">
                                    <h4>
                                        <?php 
                                ...
                                <tr>
                                    <td>
                                        <h4>Number of Bills which are not processed</h4>
                                    </td>
                                    <td class="success">
                                        <h4>
                                            <?php 
                                ...
                                <tr>
                                    <td>
                                        <h4>Number of Complaints yet to be processed</h4>
                                    </td>
                                    <td class="success">
                                        <h4>
                                            <?php 
